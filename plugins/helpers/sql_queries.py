class SqlQueries:
    ...
    truncate_user_table = ('TRUNCATE TABLE users;')
    truncate_song_table = ('TRUNCATE TABLE songs;')
    truncate_artist_table = ('TRUNCATE TABLE artists;')
    truncate_time_table = ('TRUNCATE TABLE time;')